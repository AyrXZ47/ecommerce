...
try {
   ...
   // Codigo para que funcione de manera  local xd
    ...
    $mail->addAddress($_POST['correo'], $_POST['usuario']); 
...
// Attachments
  //  $mail->addAttachment('/var/tmp/file.tar.gz');         // Add attachments
    ...
    $mail->Subject = 'Hola! '.$_POST['usuario'].' :D';
	...
	<table>
		<tr>
			<td style="background:#C70039; color:#ffffff;">
				<h1><strong>Gracias por estar con nosotros '.$_POST['usuario'].' </strong></h1>
			</td>
		</tr>
...
<a href="https://localhost/PWA/admin/index.php?modulo=verif&ADMIN='.$_POST['usuario'].'">Verificar cuenta</a></h2> <br> 
