...
try {
   ...
   // Codigo para que funcione de manera  local xd
    ...
    $mail->addAddress('yovickrzaldivar@gmail.com', 'Yovick'); 
	...
	<table>
		<tr>
			<td style="background:#C70039; color:#ffffff;">
				<h1><strong>¡Tienes una venta nueva!</strong></h1>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div>
					<p>
					<h2>Te hemos enviado éste correo para que hagas clic en el siguiente enlace y le des seguimiento a tu nueva venta: <br><br>    

<a href="https://localhost/PWA/admin/index.php?modulo=vent">Ir a mis Ventas</a></h2> <br> 
